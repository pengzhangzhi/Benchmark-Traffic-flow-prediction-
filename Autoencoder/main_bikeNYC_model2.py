...
def train_model(encoder_blocks, lstm_units, lr, batch_size, save_results=False, i=''):
    ...
    encoder_blocks = 2#int(encoder_blocks)
    lstm_units = 16#2 ** int(lstm_units)
    ...
    model = m.build_model(
        ...
        external_dim=external_dim, lr=0.00031126431110999877,
...
for i in range(0,10):
    train_model(encoder_blocks=2, #params['encoder_blocks'],
                lstm_units=16, #params['lstm_units'],
                lr=0.00031126431110999877, #params['lr'],
